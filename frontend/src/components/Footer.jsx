...
const Footer = () => {
  ...
  return (
    <div>
      <footer
        className="bg-linear-to-br from-slate-900 via-slate-800 to-slate-900 text-gray-300  py-10"
      >
        <div className=" flex flex-col sm:flex-row flex-wrap sm:justify-between gap-10 px-5 sm:px-10 md:px-32 lg:px-40 items-center">
          {/* Brand */}
